...
%  setting and tactile data (if any) to the database.  expID will be
...
% (pure JDBC drivers and the native ODBC interface provide better connectivity 
%  and performance than the JDBC / ODBC bridge)
...
experimentData.tactile_sensor_reads = MatlabToPostgresqlArray(tactileSensorReads);
