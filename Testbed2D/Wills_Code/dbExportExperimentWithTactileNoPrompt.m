function dbExportExperimentWithTactileNoPrompt(video_file_path, tactile_byte_array, finalContactMode)
...
tactile_byte_array = cell2mat(tactile_byte_array);
...
expFinalContactMode = finalContactMode;
